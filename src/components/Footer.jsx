    ...
    return <footer className="footer">
        <Container>
            <Row>
                ...
                <Col lg='3' md='6'>
                    <h6 className='text-white pt-4'>RisEd</h6>
                    <ListGroup className='link_list'>
                        {
                ...
                <Col lg='12' className=''>
                    ...
                    <div className='follows'>
                        <p className='mb-0 d-flex align-items-center justify-content-center gap-2 text-white'>©Copyrights 2024 All rights reserved.</p>
